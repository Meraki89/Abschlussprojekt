...
# program to extract the required data/information from the Wikipedia articles and accepts txt files as arguments
def extract_data(file):
    ...
    # start a loop to read every line (aka Wiki article) of the txt file and perform data extraction
